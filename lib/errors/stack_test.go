...
const (
	prefix     = "  github.com/bearz-io/bzdev/lib/errors"
	testPrefix = "  github.com/bearz-io/bzdev/lib/errors_test"
)
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		errors.New("ooh"), []string{
			"  github.com/bearz-io/bzdev/lib/errors_test.TestStackTrace\n" +
		...
		errors.Wrap(errors.New("ooh"), "ahh"), []string{
			...
			func() error { return errors.New("ooh") }(), []string{
				`  github.com/bearz-io/bzdev/lib/errors_test.TestStackTrace.func1` +
